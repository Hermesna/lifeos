        ...
        <div className="rounded-xl border border-border bg-card overflow-hidden flex flex-col justify-between hover:border-border/80 transition-colors shadow-xs">
            <div className="bg-sky-500/10 dark:bg-sky-500/5 px-4 py-3 border-b border-dashed border-sky-500/30 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    <div className="p-1.5 rounded-md bg-sky-500 text-white shadow-xs">
                ...
                {daysLeft !== null && (
                    <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-sky-500 text-white shadow-xs">
                        {daysLeft === 0
                    ...
                    <div className="grid grid-cols-2 gap-2 pt-1 border-t border-border/40">
                        <div className="bg-accent/40 p-2 rounded-lg">
                            <span className="text-[10px] text-muted-foreground flex items-center gap-1">
                                ...
                                {t("travelWidget.departure", { defaultValue: "Salida" })}
                            </span>
                            <p className="text-xs font-semibold mt-0.5">{formatDate(currentTrip.startDate)}</p>
                        </div>

                        <div className="bg-accent/40 p-2 rounded-lg">
                            <span className="text-[10px] text-muted-foreground flex items-center gap-1">
                                <Luggage className="h-3 w-3 text-sky-500" />
                                {t("travelWidget.luggage", { defaultValue: "Equipaje" })}
                            </span>
