...
const getTravelSchema = (t: TFunction) =>
    z.object({
        ...
        budget: z.coerce
            ...
            .min(
                1,
                t("travel.validation.budgetMin", "El presupuesto debe ser mayor a 0."),
            ),
    })
...
export function TravelForm() {
    ...
    const schema = useMemo(() => getTravelSchema(t), [t])
        ...
        <div className="rounded-xl border bg-card p-5 shadow-xs">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <button
                    type="submit"
                    disabled={isSaving}
                    className="w-full flex items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow hover:bg-primary/90 transition-colors disabled:opacity-50 cursor-pointer"
                >
                    {isSaving ? (
